        ...
        <div class="epkb-config-sidebar" id="epkb-config-main-setup-sidebar">
            <div class="epkb-config-sidebar-options">                        <?php
                ...
                $form->option_group( $feature_specs, array(
                    'info'              => array( 'templates_for_kb_padding_top', 'templates_for_kb_padding_bottom', 'templates_for_kb_padding_left', 'templates_for_kb_padding_right', 'templates_for_kb_article_reset', 'templates_for_kb_article_defaults' ),
