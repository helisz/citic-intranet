	...
	private function show_what_is_new() {   ?>
        ...
        <div class="eckb-whats-new">
            <div class="eckb-content">
                ...
                <p>In this release we added debugging information for easier troubleshooting and additional CSS options for KB Templates.</p>
                <a class="whats-new-button" href="https://www.echoknowledgebase.com/knowledge-base-plugin-update-3-2-0/" target="_blank"> <?php esc_html_e( "Read Full Article on our Blog", 'echo-knowledge-base' ); ?></a>
		...
		<div class="row">
			<div class="col-3">
				<h4>3.2.0, Sept 1, 2017</h4>
				<ul>
					<li>New: Add debug tab for easier troubleshooting</li>
					<li>New: Add option for KB Templates to use CSS reset and/or default CSS</li>
					<li>Fix: Use string, not array, to avoid PHP limit in posting sequence of articles</li>
