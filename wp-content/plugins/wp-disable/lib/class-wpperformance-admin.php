...
class WpPerformance_Admin {
	...
	public function __construct() {
		...
		// add_action( 'admin_bar_menu', array( $this, 'admin_topbar_menu' ), 90 );	// @note: Enables admin top bar menu.
	...
	public function admin_topbar_menu( $wp_admin_bar ) {

		$wp_admin_bar->add_menu(
			array(
				'id'     => 'optimisation-io',
				'href'   => admin_url('admin.php?page=optimisationio-wp-disable'),
				'title'  => '<div class="wp-menu-image dashicons-before dashicons-admin-generic"> ' . esc_html__( 'Optimisation.io', 'wpperformance' ) . '</div>',
				'meta'   => array(
					'title' => esc_html__( 'Optimisation.io', 'wpperformance' ),
				),
			)
		);
		...
		$wp_admin_bar->add_menu(
			array(
				'id'     => 'optimisation-io-wp-disable',
				'href'   => admin_url('admin.php?page=optimisationio-wp-disable'),
				'parent' => 'optimisation-io',
				'title'  => esc_html__( 'WP Disable', 'wpperformance' ),
				'meta'   => array(
					'title' => esc_html__( 'WP Disable', 'wpperformance' ),
				),
			)
	...
	public function menu() {
		...
		/*if( class_exists('Optimisationio') || class_exists('Wp_Image_compression') ){
			// Plugin "Cache for WordPress Performance" or/and "JPG, PNG Compression and Optimization" is/are active.
			add_menu_page( __( 'Optimisation.io', 'wpperformance' ), __( 'Optimisation.io', 'wpperformance' ), 'manage_options', 'optimisationio-wp-disable', array( $this, 'addsettings' ), 'dashicons-dashboard' );
			add_submenu_page( 'optimisationio-wp-disable', __( 'WP Disable', 'wpperformance' ), __( 'WP Disable', 'wpperformance' ), 'manage_options', 'optimisationio-wp-disable' );
		}
		else{*/
			add_menu_page( __( 'Optimisation.io', 'wpperformance' ), __( 'Optimisation.io', 'wpperformance' ), 'manage_options', 'optimisationio-wp-disable', array( $this, 'addsettings' ), 'dashicons-dashboard' );
			add_submenu_page( 'optimisationio-wp-disable', __( 'WP Disable', 'wpperformance' ), __( 'WP Disable', 'wpperformance' ), 'manage_options', 'optimisationio-wp-disable' );
