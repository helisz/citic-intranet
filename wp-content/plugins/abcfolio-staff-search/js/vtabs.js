(function( $ ) {
    ...
    $(function() {
        ...
        var vTabsMgr_1 = $( abcfVTabs.mgr_1).children( '.abcflVTabsNavCntr' ), tabIndex1 = null;
        var vTabsCntCntr_1 = abcfVTabs.cntCntr_1;
        var vTabsMgr_2 = $( abcfVTabs.mgr_2).children( '.abcflVTabsNavCntr' ), tabIndex1 = null;
        var vTabsCntCntr_2 = abcfVTabs.cntCntr_2;
    ...
    vTabsMgr_1.children().each(function() {
        $( this ).on( 'click', function( evt ) {
            ...
            if ( ! $( this ).hasClass( 'abcflVTabsTabActive' ) ) {
                ...
                $( '.abcflVTabsTabActive', abcfVTabs.mgr_1 ).removeClass( 'abcflVTabsTabActive' );
                ...
                $( vTabsCntCntr_1 )
                 ...
                 console.log( $( vTabsCntCntr_1 ).children());
    ...
    vTabsMgr_2.children().each(function() {
        $( this ).on( 'click', function( evt ) {
            ...
            if ( ! $( this ).hasClass( 'abcflVTabsTabActive' ) ) {
                ...
                // Unmark the current tab and mark the new one as active
                $( '.abcflVTabsTabActive', abcfVTabs.mgr_2 ).removeClass( 'abcflVTabsTabActive' );
                $( this ).addClass( 'abcflVTabsTabActive' );
