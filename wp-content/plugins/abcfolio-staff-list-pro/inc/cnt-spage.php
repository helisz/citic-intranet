...
function abcfsl_cnt_spage( $scodeArgs ){
    ...
    //_singleLayoutH
    $pgLayout = isset( $tplateOptns['_singleLayout'] ) ? esc_attr( $tplateOptns['_singleLayout'][0] ) : '100';
    if( $pgLayout == 1 ) { $pgLayout = 100; }
    ...
    switch ($pgLayout) {
        case 100:
            //$pgCnt = abcfsl_cnt_spage_cnt_100( $staffMemberID, $tplateOptns, $vAid, $clsPfix, $pgLayout );
            $outItem = abcfsl_cnt_spage_cnt_100( $staffMemberID, $tplateOptns, $vAid, $clsPfix, $pgLayout );
            break;
        default:
            break;
    }
...
function abcfsl_cnt_spage_cnt_100( $staffMemberID, $tplateOptns, $vAid, $clsPfix, $pgLayout ){
...
function abcfsl_cnt_spage_img_cntr( $staffMemberID, $tplateOptns, $itemOptns, $colL, $clsPfix, $pgLayout, $vAid ){
    ...
    return abcfsl_cnt_image_cntr( $tplateOptns, $itemOptns, $par  );
}
