...
//    $bkgColor = 0; if($vAid == 'Y') { $bkgColor = 0; }
...
function abcfsl_cnt_social_icon_a_tag( $fileBaseName, $iconTitle, $href, $socialSource, $imgsFolderUrl, $clsPfix, $baseCls, $customCls, $isSingle ){
    ...
    $imgTag = abcfl_html_img_tag('', $imgUrl, $iconTitle, $iconTitle, '', '', $iconCls, $iconStyle);
...
//Figure out $fileBaseName from Custom Social Link.
//In: Icon title. Value of: Custom Social Link 1.......
...
function abcfsl_cnt_social_custom_icon_basename( $iconTitle, $no ){
    ...
    //Get filename of icon included in the plugin or empty string.
    switch ( $iconTitleL ) {
        case 'email':
        case 'facebook':
        case 'googleplus':
