...
function abcfsl_mbox_tplate_structured_data( $tplateOptns ) {
    ...
    echo  abcfl_html_tag('div','','inside  hidden');
        ...
        //$lblreference = abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta(181, ' (schema.org)'), abcfsl_aurl(47), 'abcflFontWP abcflFontS12 abcflFontW400' );

        abcfsl_mbox_tplate_field_section_hdr( 46, 180, false);

        $lblType = abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta(181, ' (schema.org)'), abcfsl_aurl(47), 'abcflFontWP abcflFontS12 abcflFontW400' );
        echo abcfl_input_txt('sdType', '', $sdType, $lblType, '', '50%', '', '', 'abcflFldCntr', 'abcflFldLbl');

        abcfsl_mbox_tplate_field_section_hdr( 61, 184, true);
