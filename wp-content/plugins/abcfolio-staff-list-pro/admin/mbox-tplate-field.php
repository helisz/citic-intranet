...
function abcfsl_mbox_tplate_field( $tplateOptns, $F ){
    ...
    switch ( $fieldTypeH ){
        case 'STXT': //Static Text
            ...
            abcfsl_mbox_tplate_field_input_label_1( $inputLbl, $F, 208, 282  );

            abcfsl_mbox_tplate_field_section_hdr( 52, 182 );
            abcfsl_mbox_tplate_field_input_static_txt( $statTxt, $statTxtFs, $F );
            //------------------------------------------------
        ...
        case 'LT': //Static Label + Text
            ...
            //Static label
            abcfsl_mbox_tplate_field_input_static_lbl( $lblTxt, $F, 292, 293, '' );
            abcfsl_mbox_tplate_field_input_label( $inputLbl, $inputHlp, $F, 208, 282, 209, 257, 0, 'inputLbl_', 'inputHlp_' );
            //------------------------------------------------
            abcfsl_mbox_tplate_field_section_hdr( 5, 286 );
            abcfsl_mbox_tplate_field_show_field( $showField, $hideDelete, $F );
        ...
        case 'TH': //Static text + Hyperlink
            ...
            //Static text
            abcfsl_mbox_tplate_field_input_static_lbl( $lblTxt, $F, 259, 264, '' );
            abcfsl_mbox_tplate_field_input_label( $inputLinkUrlLbl, $inputLinkUrlHlp, $F, 302, 282, 317, 257, 0, 'lnkUrlLbl_', 'lnkUrlHlp_' );
            //----------------------------------
            abcfsl_mbox_tplate_field_section_hdr( 5, 286 );
            abcfsl_mbox_tplate_field_show_field( $showField, $hideDelete, $F );
        ...
        case 'HL': //PRO --- Horizontal Line
            ...
            abcfsl_mbox_tplate_field_input_label_1( $inputLbl, $F, 208, 282, 'inputLbl_' );
            //------------------------------------------------
            abcfsl_mbox_tplate_field_section_hdr( 5, 286 );
            abcfsl_mbox_tplate_field_show_field( $showField, $hideDelete, $F );
            abcfsl_mbox_tplate_field_cntr_spg( $fieldCntrSPg, $F );
        ...
        case 'SC': //PRO --- Shortcode
            abcfsl_mbox_tplate_field_section_hdr( 21 );
            abcfsl_mbox_tplate_field_input_label( $inputLbl, $inputHlp, $F, 208, 282, 209, 257, 0, 'inputLbl_', 'inputHlp_' );
            //------------------------------------------------
            abcfsl_mbox_tplate_field_section_hdr( 5, 286 );
            abcfsl_mbox_tplate_field_show_field( $showField, $hideDelete, $F );
...
function abcfsl_mbox_tplate_field_sd_property( $sdProperty, $F ){
    $lbl = abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta(179, ' (schema.org)'), abcfsl_aurl(48), 'abcflFontWP abcflFontS12 abcflFontW400' );
...
//Generic Text input.
function abcfsl_mbox_tplate_field_input_static_lbl( $lblTxt, $F, $name=292, $help=293, $suffix='' ){
    echo abcfl_input_txt('lblTxt_' . $F, '', $lblTxt, abcfsl_txta_r( $name, $suffix ), abcfsl_txta($help), '50%', '', '', 'abcflFldCntr', 'abcflFldLbl');
}

function abcfsl_mbox_tplate_field_input_static_txt( $statTxt, $statTxtFs, $F ){
