<?php
function abcfsl_mbox_tplate_spg_optns( $tplateOptns ){
    ...
    echo  abcfl_html_tag('div','','inside hidden');
        ...
        //$lbl = abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta_r(271), abcfsl_aurl(12), 'abcflFontWP abcflFontS13 abcflFontW400' );
