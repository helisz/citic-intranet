...
function abcfsl_mbox_item_text_T( $tplateOptns, $itemOptns, $F, $showField ){
    ...
    if($showField == 2) {
        echo abcfl_input_txt_readonly('ro_txt_' . $F, '', $txt, $lbl, '', '100%', '', '', 'abcflFldCntr', 'abcflFldLbl  abcflFontW700');
    }
    else{
        echo abcfl_input_txt('txt_' . $F, '', $txt, $lbl, $inputHlp, '100%', '', '', 'abcflFldCntr', 'abcflFldLbl  abcflFontW700');
    }
}
...
function abcfsl_mbox_item_text_STXT( $tplateOptns, $itemOptns, $F, $showField ){
    ...
    echo abcfl_input_txt_readonly('ro_txt_' . $F, '', $txt, $lbl, '', '100%', '8', '', 'abcflFldCntr', 'abcflFldLbl  abcflFontW700');
}
...
function abcfsl_mbox_item_text_PT( $tplateOptns, $itemOptns, $F, $showField ){
    ...
    if($showField == 2) {
        echo abcfl_input_txtarea_readonly('ro_txt_' . $F, '', $txt, $lbl, '', '100%', '8', '', 'abcflFldCntr', 'abcflFldLbl  abcflFontW700');
    }
    else{
        echo abcfl_input_txtarea('txt_' . $F, '', $txt, $lbl, $inputHlp . ' ' . abcfsl_txta(221), '100%', '10', '', '', '', 'abcflFldCntr', 'abcflFldLbl  abcflFontW700');
    }
}
...
function abcfsl_mbox_item_text_SH( $tplateOptns, $F, $showField ){
    ...
    if($showField == 0) { return ''; }
    $lblTx = isset( $tplateOptns['_lblTxt_' . $F] ) ? esc_attr( $tplateOptns['_lblTxt_' . $F][0] ) : '';
    echo abcfl_input_txt_readonly('ro_txt_' . $F, '', $lblTx, '', '', '100%', '', '', 'abcflFldCntr', 'abcflFldLbl  abcflFontW700');
}
