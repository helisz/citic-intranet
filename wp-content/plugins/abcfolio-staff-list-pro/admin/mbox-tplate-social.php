...
function abcfsl_mbox_tplate_social_items( $showSocial, $showSocialOn, $socialSource, $social1, $social2, $social3, $socialCntrLbl, $socialCntrHlp, $cntrCls, $cntrStyle, $socialTM ){
    ...
    echo abcfl_input_txt('social2', '', $social2, abcfsl_txta(62, ' 2'), abcfsl_txta(236), '50%', '', '', 'abcflFldCntr', 'abcflFldLbl');
    echo abcfl_input_txt('social3', '', $social3, abcfsl_txta(62, ' 3'), abcfsl_txta(236), '50%', '', '', 'abcflFldCntr', 'abcflFldLbl');

    //---------------------
    echo abcfl_input_hline('2');
    echo abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta(239), '' );
    echo abcfl_input_info_lbl(abcfsl_txta(227), 'abcflMTop5', '11');
