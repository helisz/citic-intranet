...
function abcfsl_mbox_tplate_spg_layout_optns_pg( $spgCntrW, $spgCntrCls, $spgCntrStyle, $spgACenter){
    ...
    abcfl_input_sec_icon_hdr_hlp( ABCFSL_ICONS_URL, 'staff-single-pg.png', abcfsl_txta(69)  . ' ' . abcfsl_txta(13), abcfsl_txta(322), abcfsl_aurl(9) );
...
function abcfsl_mbox_tplate_spg_layout_optns_m( $spgCols, $spgMMarginT ){
    ...
    echo abcfl_input_cbo('spgCols', '',$cboCols, $spgCols, abcfsl_txta_r(253), abcfsl_txta(308), '50%', true, '', '', 'abcflFldCntr', 'abcflFldLbl');
